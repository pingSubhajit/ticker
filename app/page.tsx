	...
	return (
		<main className="flex min-h-svh w-screen mx-auto max-w-[700px] flex-col items-start justify-end p-8 gap-8">
			<h1 className="flex flex-col text-5xl leading-[1.15] lg:flex-row lg:flex-wrap">
				...
				<span><span className="italic whitespace-nowrap">time</span> <span className="underline decoration-yellow-400 whitespace-nowrap">of your</span></span>
			...
			<Image src={stopwatch} alt="Stopwatch image used for illustrative purposes" className="mt-8 mx-auto max-w-48" />
